                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 mb-2">
                                ...
                                <select class="form-control select2" data-toggle="select2" name="employer"
                                    ...
                                    @foreach ($employers as $emp)
                                        <option value="{{ $emp->id }}"
                                            {{ old('employer', $job->employer_id) == $emp->id ? 'selected' : '' }}>
                                ...
                                <select id="sub_classification" class="form-select" name="sub_classification">
                                    ...
                                    @foreach ($subclassifications as $subclassification)
                                        <option value="{{ $subclassification->id }}"
                                            {{ old('sub_classification', $job->sub_classification_id) == $subclassification->id ? 'selected' : '' }}>
                            ...
                            <div class="col-sm-6 mb-2 {{ $errors->has('no_of_position') ? 'has-error' : '' }}">
                                ...
                                @error('no_of_position')
                                    <span id="no_of_position-error" class="error invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-sm-6 mb-2">
                                ...
                                <select id="salary_type" class="form-select" name="salary_type">
                                    ...
                                    <option value="Month Range"
                                        {{ old('salary_type', $job->salary_type) == 'Month Range' ? 'selected' : '' }}>Month Range</option>
                                    <option value="Month Fixed"
                                        {{ old('salary_type', $job->salary_type) == 'Month Fixed' ? 'selected' : '' }}>Month Fixed
                                    </option>
                            ...
                            <div class="col-sm-6 mb-2">
                                ...
                                <select id="career_level" class="form-select" name="career_level">
                                    ...
                                    <option value="Entry Level"
                                        {{ old('career_level', $job->career_level) == 'Entry Level' ? 'selected' : '' }}>
                                        Entry Level</option>
                            ...
                            <div class="col-sm-6 mb-2 {{ $errors->has('area') ? 'has-error' : '' }}">
                                ...
                                <select name="area" id="area" class="form-select" onchange="getSubzones();">
                                    ...
                                    <option value="{{ $area->id }}"
                                        {{ old('area', $job->area_id) == $area->id ? 'selected' : '' }}>{{ $area->name }}
                                    </option>
                                @endforeach
                                </select>
                                @error('area')
                            ...
                            <div class="col-sm-6 mb-2 {{ $errors->has('subzone') ? 'has-error' : '' }}">
                                ...
                                <select name="subzone" id="subzone" class="form-select">
                                    ...
                                    <option value="{{ $subzone->id }}"
                                        {{ old('subzone', $job->sub_zone_id) == $subzone->id ? 'selected' : '' }}>{{ $subzone->name }}
                                    </option>
                                @endforeach
                                </select>
                                @error('subzone')
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12 mb-2">
                                <label class="col-form-label" for="education">{{ __('Education') }} <span
                                        class="text-danger">*</span></label>
                                        ...
                                        @foreach ($educations as $edu)
                                            <option value="{{ $edu }}"
                                            {{ old('education',$job->education) == $edu ? 'selected' : '' }}>
                                                {{ $edu }}</option>
                                       @endforeach
                            ...
                            <div class="col-sm-12 mb-2">
                               ...
                               {{--  <select name="skills[]" class="select2 form-control select2-multiple"
                                    ...
                                    @foreach ($skills as $skill)
                                        <option value="{{ $skill }}" {{ collect(old('skills', $job->skills_required))->contains($skill) ? 'selected' : '' }}>{{ $skill }}</option>
                                    @endforeach
                                </select> --}}
                                <div class="row">
                                    <div class="col-sm-12">
                            ...
                            <div class="col-sm-12 mb-2">
                                ...
                                <div class="col-sm-6 mb-2">
                                    <label class="col-form-label" for="working_hours">{{ __('Start Time') }} <span
                                            class="text-danger">*</span></label>
                                    <input class="form-control" id="working_start_hours" type="text"
                                ...
                                <div class="col-sm-6 mb-2">
                                    <label class="col-form-label" for="working_hours">{{ __('End Time') }} <span
                                            class="text-danger">*</span></label>
                                    <input class="form-control" id="working_end_hours" type="text"
                        ...
                        <div class="row">
                            <div class="col-sm-6 mb-2">
                                ...
                                <select id="job_approved" class="form-select" name="job_approved">
                                    ...
                                    <option value="approved" {{ old('job_approved', $job->status) == 'approved' ? 'selected' : '' }}>
                                        Yes</option>
                                    <option value="pending" {{ old('job_approved', $job->status) == 'pending' ? 'selected' : '' }}>No
                                    </option>
                            ...
                            <div class="col-sm-6 mb-2">
                                ...
                                <select id="job_status" class="form-select" name="job_status">
                                    ...
                                    <option value="1" {{ old('job_status', $job->open) == '1' ? 'selected' : '' }}>
                                        Open</option>
                                    <option value="0" {{ old('job_status', $job->open) == '0' ? 'selected' : '' }}>Closed
                                    </option>
