...
@section('content')
    ...
    <div class="container-fluid">
            ...
            <div class="col-12">
                <div class="page-title-box">
                    <div class="page-title-right">
                        ...
                        <button type="submit" class="btn btn-sm btn-dark" form="categoryForm"><i
                                class="mdi mdi-database-edit me-1"></i>Update</button>
                    </div>
        ...
        <form id="categoryForm" method="POST" action="{{ route('admin.pages.update', $page->id) }}"
                ...
                <div class="col-lg-12">
                        ...
                        <div id="collapseseo" class="collapse show" aria-labelledby="seoAccordian"
                            ...
                            <div class="card-body">
                                ...
                                <div class="col-md-12 mb-2 {{ $errors->has('meta_description') ? 'has-error' : '' }}">
                                    ...
                                    <textarea id="meta_description" class="form-control" name="meta_description" rows="4">{{ old('meta_description', $page->meta_description) }}</textarea>
                    ...
                    <div class="card accordion custom-accordion">
                        <div class="card-header bg-dark" id="imageAccordian">
                            <h5 class="m-0">
                                <a class="custom-accordion-title text-white" data-bs-toggle="collapse" href="#collapseImage"
                            ...
                            <div id="collapseBanner" class="collapse show" aria-labelledby="bannerAccordian"
                                ...
                                <div class="card-body">
                                    <div class="col-md-12 mb-2 {{ $errors->has('banner') ? 'has-error' : '' }}">
                                        ...
                                        <img id="banner_img" src="{{ $page->banner }}" class="mt-2 img-fluid">
                                        @error('banner')
                    ...
                    <div class="card-footer text-end">
                        <a href="{{ url()->previous() }}" class="btn btn-sm btn-dark me-1"><i
                                class="mdi mdi-chevron-double-left me-1"></i>Back</a>
                        <button type="submit" class="btn btn-sm btn-success" form="categoryForm"><i
                                class="mdi mdi-database-edit me-1"></i>Update</button>
                    </div>
                </div>
            </div>
