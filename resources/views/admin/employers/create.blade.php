...
@section('content')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Create Employer</h4>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-12">
            <form id="employerForm" method="POST" action="{{ route('admin.employers.store') }}"
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-sm-6 mb-2 {{ $errors->has('password') ? 'has-error' : '' }}">
                                <label class="col-form-label" for="password">Password <span class="text text-danger">*</span></label>
                            ...
                            <div class="col-sm-6 mb-2 {{ $errors->has('password_confirmation') ? 'has-error' : '' }}">
                                <label class="col-form-label" for="password_confirmation">Confirm Password <span class="text text-danger">*</span></label>
