...
@section('content')
    ...
    <div class="container">
        <h5 class="login-title">Post Job</h5>
        <div class="post-form">
            <form id="jobForm" method="POST" action="{{ route('post-job') }}" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 mb-2">
                            ...
                            <select id="salary_type" class="form-select" name="salary_type">
                                ...
                                <option value="Month Range" {{ old('salary_type') == 'Month Range' ? 'selected' : '' }}>
                                    Month Range</option>
                                <option value="Month Fixed" {{ old('salary_type') == 'Month Fixed' ? 'selected' : '' }}>
                                    Month Fixed
                                </option>
                        ...
                        <div class="col-sm-6 mb-2">
                            ...
                            <select id="career_level" class="form-select" name="career_level">
                                ...
                                <option value="Entry Level" {{ old('career_level') == 'Entry Level' ? 'selected' : '' }}>
                                    Entry Level</option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 mb-2">
                            ...
                            <select id="hide_salary" class="form-select" name="hide_salary">
                                <option value="0" {{ old('hide_salary') == '0' ? 'selected' : '' }}>No
                                </option>
                                <option value="1" {{ old('hide_salary') == '1' ? 'selected' : '' }}>
                                    Yes</option>
        ...
        function getSubclassifications() {
            ...
            $.ajax({
                ...
                success: function(res, status) {
                    ...
                    $('#sub_classification').val('{{ old('sub_classification') }}');
                },
                error: function(res, status) {
                    console.log(res);
                }
