            ...
            <li class="clearfix">
                <div class="chat-avatar">
                    @if ($chat->employee->avatar)
                        <img src="{{ asset('storage/uploads/employees/' . $chat->employee->slug . '/' . $chat->employee->avatar . '') }}">
                    @else
                ...
                <div class="conversation-text">
                    <div class="ctext-wrap">
                        <i>{{ $chat->employee->firstname ?? '' }} {{ $chat->employee->lastname ?? '' }}</i>
                        <p>
            ...
            <li class="clearfix odd">
                <div class="chat-avatar">
                    @if ($chat->employer->avatar)
                        <img
                            src="{{ asset('storage/uploads/employers/' . $chat->employer->slug . '/' . $chat->employer->avatar . '') }}">
                    @else
