...
@section('content')
<h5 class="page-title">Closed Jobs</h5>
    @forelse($jobs as $job)
    <div class="JobList">
        ...
        <div class="openings mb-2 mt-2">
                {{ $job->region->name }}</span>
            <span class="openingtotal me-3"><img src="{{ asset('assets/images/icons/users.png') }}"
                    alt="Users"> Openings <b>{{ $job->no_of_position }}</b></span>
            <span class="salary"><img src="{{ asset('assets/images/icons/dollar.png') }}"
        ...
        <a href="{{ route('job.applicants', $job->id) }}" class="view_applicant btn btn-outline-primary">View Applicants</a>
